...
public record SipURI (
	...
	public static SipURI parse(CharSequence charSequence) {
		...
		return new SipURI(protocol, credentials, new Address(host, port), uriParameters, queryParameters);
	}

	private static Map<String, String> parseParameters(String str, String delimiter) {
