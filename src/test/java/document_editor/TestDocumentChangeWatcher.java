...
//			StreamObserver<DocumentChangedEvents> streamObserver = invocationOnMock.getArgument(1);
//
//			streamObserver.onNext(DocumentChangedEvents.newBuilder()
...
//						eq(SubscribeForDocumentChangesRequest.newBuilder()
